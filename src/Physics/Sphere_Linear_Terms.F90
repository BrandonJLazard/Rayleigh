...
Contains
    ...
    !Check over this subroutine again. I think some of the variables don't need to be defined
    !Double check the apply_boundary_mask subroutines in the linear_solve file 
    !Brandon
    Subroutine Enforce_Boundary_Conditions_Compressible()
        Implicit None
        Real*8 :: bc_val
        Integer :: uind, lind
    ...
    End Subroutine Enforce_Boundary_Conditions_Compressible       
