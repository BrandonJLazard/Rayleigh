...
Module PDE_Coefficients
    ...
    Type ReferenceInfo
        ...
        Real*8 :: Centrifugal_Coeff !Brandon 
    ...
    ! Compressible nondimensional numbers
    Real*8 :: bigz = 0.0d0 !Brandon
    Real*8 :: gas_gamma = 5.0d0/3.0d0 !Brandon
...
Contains
    ...
    Subroutine Constant_Reference()
        ...
        ref%Centrifugal_Coeff     =  1.0d0/(Ekman_Number**2) ! Brandon
        nu_top       = 1.0d0
